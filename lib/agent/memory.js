...
function createMemoryService(store, { settingsFor = () => DEFAULT_MEMORY_SETTINGS } = {}) {
  ...
  function ensureBuiltinMemories() {
    ...
    upsert(BUILTIN_SEEDREAM_MEMORY, BUILTIN_SEEDREAM_VERSION, 'builtin-seedream-generate');
    upsert(BUILTIN_GETOKEN_MEMORY, BUILTIN_GETOKEN_VERSION, 'builtin-getoken-generate');
