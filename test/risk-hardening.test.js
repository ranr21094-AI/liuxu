...
test('log main page uses archive layout while preserving existing controls', () => {
  ...
  assert.match(styleSource, /\.log-card\s*\{[\s\S]*height:\s*352px;/);
  assert.match(styleSource, /\.log-card-content\s*\{[\s\S]*overflow:\s*hidden;/);
  assert.match(styleSource, /\.log-card-content::after\s*\{[\s\S]*height:\s*34px;/);
  ...
  assert.match(styleSource, /@media \(max-width: 768px\)[\s\S]*\.log-card\s*\{[\s\S]*height:\s*280px;/);
...
test('category manager uses drag sorting and log count badges without move buttons', () => {
  ...
  assert.match(styleSource, /\.cat-graph-view::before\s*\{[\s\S]*background-image:[\s\S]*radial-gradient/);
  assert.match(styleSource, /\.cat-graph-lines\s*\{[\s\S]*pointer-events:\s*none;/);
  assert.match(styleSource, /\.cat-graph-orbit\s*\{[\s\S]*stroke-dasharray:\s*5 7;/);
  assert.match(styleSource, /\.cat-graph-orbit\.active\s*\{[\s\S]*stroke-width:\s*2\.2;/);
  ...
  assert.match(styleSource, /\.cat-graph-parent\s*\{[\s\S]*border-radius:\s*50%;/);
...
test('AI chat frontend supports local history and refreshed workspace layout', () => {
  ...
  assert.match(styleSource, /\.ai-chat-shell\s*\{[\s\S]*width:\s*min\(1140px, 100%\);[\s\S]*grid-template-rows:\s*minmax\(0, 1fr\) auto;/);
  ...
  assert.match(styleSource, /\.ai-history-list\s*\{[\s\S]*gap:\s*8px;/);
  assert.match(styleSource, /\.ai-history-item\s*\{[\s\S]*grid-template-columns:\s*minmax\(0, 1fr\) 24px 24px;[\s\S]*height:\s*72px;/);
  assert.match(styleSource, /\.ai-history-action\s*\{[\s\S]*width:\s*24px;[\s\S]*height:\s*24px;/);
  assert.match(styleSource, /\.ai-chat-composer-actions\s*\{[\s\S]*gap:\s*10px;/);
  assert.match(styleSource, /\.ai-chat-composer\s*\{[\s\S]*border:\s*1px solid rgba\(226, 232, 240, 0\.96\);[\s\S]*background:\s*rgba\(255, 255, 255, 0\.96\);/);
  assert.match(styleSource, /\.ai-chat-composer textarea\s*\{[\s\S]*min-height:\s*72px;[\s\S]*max-height:\s*144px;/);
  assert.match(styleSource, /\.ai-chat-composer-footer\s*\{[\s\S]*border-top:\s*1px solid rgba\(226, 232, 240, 0\.8\);/);
  assert.match(styleSource, /\.ai-chat-web-toggle\s*\{[\s\S]*min-height:\s*34px;[\s\S]*background:\s*rgba\(248, 250, 252, 0\.96\);/);
  ...
  assert.match(styleSource, /\.ai-chat-body\s*\{[\s\S]*border-radius:\s*18px;[\s\S]*overflow-y:\s*auto;[\s\S]*overflow-x:\s*hidden;/);
  ...
  assert.match(styleSource, /\.ai-chat-messages\s*\{[\s\S]*max-width:\s*920px;[\s\S]*padding:\s*28px 30px 34px;/);
  assert.match(styleSource, /\.ai-message\.assistant \.ai-message-bubble\s*\{[\s\S]*max-width:\s*min\(840px, 100%\);/);
  ...
  assert.match(styleSource, /\.ai-chat-composer textarea\s*\{[\s\S]*min-height:\s*72px;[\s\S]*max-height:\s*144px;[\s\S]*resize:\s*none;/);
  ...
  assert.match(styleSource, /@media \(max-width: 768px\)[\s\S]*\.ai-chat-messages\s*\{[\s\S]*padding:\s*16px 14px 196px;/);
